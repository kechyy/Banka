...
<div class=" modal-content">
    ...
    <div class="modal-body">
      <div class="row loginForm">
        ...
        <div class="col-12-xs"><button class="btn btn-pink btn-full btnHover"   onclick="login()">Sign in</button><br/><br/>
  ...
  <div class=" modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-12-xs"><input type="test" class="input-block" minlength="3" required name="lastName" id="lastName" placeholder="Enter Last name"></div>
          ...
          <div class="col-12-xs"><input type="password" class="input-block" minlength="6" required name="cpassword" id="cpassword" placeholder="Enter password"></div>
